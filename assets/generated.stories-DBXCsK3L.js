import{r as b,j as e}from"./iframe-BXcaScTf.js";import{m as l}from"./mox.config-C5hDLZc_.js";import"./preload-helper-Blwmkukt.js";const u={title:"MoxCSS/Atoms/Properties"},c=r=>r.replace(/[^a-zA-Z0-9-]/g,"-"),a=()=>{const[r,x]=b.useState({}),p=(t,i)=>()=>{x(n=>({...n,[t]:i}))};return e.jsxs("div",{children:[e.jsx("style",{children:`
h1, p, code {
all: revert;    
}
code {
