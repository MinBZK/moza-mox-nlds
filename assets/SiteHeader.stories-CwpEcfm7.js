...
Bekijk de full-screen versie door op de rechterbovenknop te klikken: ↗️`}}},argTypes:{}},p=g(`<MoxPageGrid>
    ...
    </MoxPageGrid>`),a={args:{},parameters:{docs:{description:{story:g(`<MoxPageGrid>
      <MoxGridItem gridColumn={"page"}>
    ...
    </MoxPageGrid>`)}}}},s={args:{pageStartSlot:c.jsx("a",{href:"#",children:c.jsxs(m,{gap:"xs",children:[c.jsx(e,{children:"Site title"}),c.jsx(e,{fontSize:"sm",fontStyle:"italic",children:"Tagline"})]})}),LogoImageWrapper:({children:t})=>c.jsx("a",{href:"#",children:t})},parameters:{docs:{description:{story:p}}}},l={args:{lintEndSlot:c.jsx("a",{href:"#",children:c.jsxs(m,{gap:"xs",children:[c.jsx(e,{children:"Site title"}),c.jsx(e,{fontSize:"sm",fontStyle:"italic",children:"Tagline"})]})})},parameters:{docs:{description:{story:p}}}},d={args:{pageStartSlot:c.jsx("a",{href:"#",children:c.jsxs(m,{gap:"xs",children:[c.jsx(e,{children:"Site title"}),c.jsx(e,{fontSize:"sm",fontStyle:"italic",children:"Tagline"})]})}),lintEndSlot:c.jsx("a",{href:"#",children:c.jsxs(m,{gap:"xs",children:[c.jsx(e,{children:"Another Site title"}),c.jsx(e,{fontSize:"sm",fontStyle:"italic",children:"Another Tagline"})]})})},parameters:{docs:{description:{story:`Dit zou niet moeten voorkomen: kies voor een page-start of lint-end <title className="" />
...
}`,...d.parameters?.docs?.source}}};const Y=["Default","PageStartTitleWithLogoLink","LintEndTitle","twoTitles"];export{a as Default,l as LintEndTitle,s as PageStartTitleWithLogoLink,Y as __namedExportsOrder,F as default,d as twoTitles};
