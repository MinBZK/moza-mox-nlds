import{j as e}from"./iframe-B_KLPEyi.js";import{g as b}from"./getStylePropArgTypes-Bz_NPbZl.js";import{c as h}from"./clsx-B-dksMZM.js";import{p as k}from"./propsToClassNames-BakxoANU.js";import{M as r}from"./Box-SZ30tWzn.js";import{M as y}from"./GridItem-CRnoyys_.js";import"./preload-helper-Blwmkukt.js";import"./mox.config-C_BHjMHX.js";const i=["itemSize"],t=({children:s,as:c,className:l,ref:m,...p})=>{const u=c||"div",{stylePropClassNames:g,restProps:x}=k(i,p);return e.jsx(u,{ref:m,className:h("mox-container-grid",...g,l),...x,children:s})};t.__docgenInfo={description:`Container grid component.
