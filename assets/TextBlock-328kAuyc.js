import{j as p}from"./iframe-B3yi9PtC.js";import{c}from"./clsx-B-dksMZM.js";import{p as m}from"./propsToClassNames-CaYXZ-nc.js";const d=["color","fontSize","fontStyle","fontWeight","lineHeight","underline","underlineHover"],e=({children:t,as:n,className:o,ref:s,...i})=>{const a=n||"span",{stylePropClassNames:r,restProps:l}=m(d,i);return p.jsx(a,{ref:s,...l,className:c("mox-text-block",r,o),children:t})},h=e;e.__docgenInfo={description:`A text component to be used for any text content.
