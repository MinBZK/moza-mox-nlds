...
`)}return m},o=String.raw,b={0:o`
  ...
  `,circle:o`
    border-radius: 50%;
  `},x=n=>({...b,"lint-0.25":o`border-${n}-radius: calc(0.25 * var(--mox-lint-inline-size));`,"lint-0.5":o`border-${n}-radius: calc(0.5 * var(--mox-lint-inline-size));`,"lint-1":o`border-${n}-radius: calc(1 * var(--mox-lint-inline-size));`,"lint-2":o`border-${n}-radius: calc(2 * var(--mox-lint-inline-size));`,"lint-4":o`border-${n}-radius: calc(4 * var(--mox-lint-inline-size));`,"lint-8":o`border-${n}-radius: calc(8 * var(--mox-lint-inline-size));`}),w={borderRadius:{options:b,responsive:!0},borderStartStartRadius:{options:x("start-start"),responsive:!0},borderStartEndRadius:{options:x("start-end"),responsive:!0},borderEndStartRadius:{options:x("end-start"),responsive:!0},borderEndEndRadius:{options:x("end-end"),responsive:!0},borderWidth:{options:{0:o`
        border-width: 0;
      `,"1px":o`
        border-width: 1px;
      `,"2px":o`
      ...
      `,5:o`
        order: 5;
      `},responsive:!0}},e=String.raw,y={direction:{options:{row:e`
        flex-direction: row;
      `,column:e`
      ...
      `,none:p`
        text-decoration: none;
      `},state:"hover"}},a=String.raw,S={fontSize:{options:i.reduce((n,r)=>(n[r]=a`
          --current-font-size: var(--mox-space-${r});
          font-size: var(--current-font-size);
        `,n),{}),responsive:!0},fontStyle:{options:{normal:a`
        font-style: normal;
      `,italic:a`
        font-style: italic;
      `}},color:{options:d.reduce((n,r)=>({...n,[r]:a`
          --text-color: var(--mox-color-${r});
          color: var(--text-color);
        `}),{})},colorHover:{options:d.reduce((n,r)=>({...n,[r]:a`
      ...
      `,tight:a`
        line-height: 1.3;
      `}}},c=String.raw,$={display:{options:{block:c`
        display: block;
        display: flow-root;
      `,inline:c`
        display: inline;
      ...
      `,contents:c`
        display: contents;
      `},responsive:!0}},z={mobile:600,tablet:900,desktop:1200,mq1440:1440},j={cq200:200,cq400:400,cq600:600,cq800:800},C={...y,...k,...S,...w,...$},E={prefix:"mox",viewportBreakpoints:z,containerBreakpoints:j,props:C};export{E as m};
