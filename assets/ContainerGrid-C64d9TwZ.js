import{j as d}from"./iframe-BXcaScTf.js";import{c as p}from"./clsx-B-dksMZM.js";import{p as m}from"./propsToClassNames-CYgz3h9B.js";const l=["itemSize","gap","rowGap","columnGap","flex"],c=({children:e,as:n,className:r,ref:i,...t})=>{const o=n||"div",{stylePropClassNames:a,restProps:s}=m(l,t);return d.jsx(o,{ref:i,className:p("mox-container-grid",...a,r),...s,children:e})};c.__docgenInfo={description:`Container grid component.
