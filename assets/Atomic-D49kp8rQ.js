import{j as e}from"./iframe-B_KLPEyi.js";import{useMDXComponents as o}from"./index-BIqBkf-a.js";import{M as l}from"./blocks-Bg6KTJbz.js";import"./preload-helper-Blwmkukt.js";import"./index-DVQbX9_I.js";const t="/moza-mox-nlds/assets/atomic-design-system-moZ-3hAD.png",d="/moza-mox-nlds/assets/tokens-atoms-etc-aT-pMjYS.png";function i(s){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",ul:"ul",...o(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(l,{title:"Atomic system"}),`
...
`,e.jsxs(n.li,{children:["Nooit omringende spacing zoals ",e.jsx(n.code,{children:"padding"})," of ",e.jsx(n.code,{children:"margin"})]}),`
`]}),e.jsx(n.h3,{id:"lv-4-5---templates-pages",children:"lv. 4, 5 - Templates, Pages"}),e.jsx(n.p,{children:"Sommige pagina's of onderdelen ervan zullen een gebruikelijke opbouw hebben. Denk bijvoorbeeld aan een basis-homepage of een contact-formulier. Heel complex, heel opinionated, maar fijn om te gebruiken als je de 'standaard' gewoon wilt gebruiken."})]})})]})}function j(s={}){const{wrapper:n}={...o(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(i,{...s})}):i(s)}export{j as default};
